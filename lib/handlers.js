        ...
        _data.read('tokens', token, (err, tokenData) => {
            ...
            _data.read('users', userPhone, (err, userData) => {
                ...
                if (userChecks.length < config.maxChecks) {
                    // Verify the given URL has DNS entries and can resolve
                    ...
                    dns.resolve(hostName, (err, records) => {
                        if (err || !records) return callback(400, { Error: 'The hostname of the URL entered did not resolve to any DNS entries' });
